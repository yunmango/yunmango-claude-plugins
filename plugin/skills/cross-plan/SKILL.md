...
- **run_in_background**: `true`
- **name**: `codex-planner`
- **prompt**: Instruct the agent to run the bundled script. The script has the model (`gpt-5.4`) and reasoning effort (`xhigh`) hardcoded — the agent must NOT modify the script or run codex directly.
...
---
*Cross-verified by Claude Opus 4.6 + GPT-5.4 (xhigh reasoning)*
```
